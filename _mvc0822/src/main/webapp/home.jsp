...
<body>
	...
	<header>
		<div class="inner">
			...
			<ul id="gnb">
				...
				<li><a href="${pageContext.request.contextPath}/list">커뮤니티</a></li>
	...
	<figure>
		<video src="${pageContext.request.contextPath}/img/visual.mp4"
	...
	<section>
		<div class="inner">
			...
			<div class="wrap">
				<article>
					<div class="pic">
						<img src="${pageContext.request.contextPath}/img/news1.jpg"
							alt="1번째 콘텐츠 이미지">
					</div>
					<h2>
				...
				<article>
					<div class="pic">
						<img src="${pageContext.request.contextPath}/img/news2.jpg"
							alt="2번째 콘텐츠 이미지">
					</div>
					<h2>
						<a href="#">Lorem ipsum dolor sit.</a>
				...
				<article>
					<div class="pic">
						<img src="${pageContext.request.contextPath}/img/news3.jpg"
							alt="3번째 콘텐츠 이미지">
					</div>
					<h2>
						<a href="#">Lorem ipsum dolor sit.</a>
				...
				<article>
					<div class="pic">
						<img src="${pageContext.request.contextPath}/img/news4.jpg"
							alt="4번째 콘텐츠 이미지">
					</div>
					<h2>
						<a href="#">Lorem ipsum dolor sit.</a>
